...
<head>
    ...
    <link rel="stylesheet" href="<?= public_url('styles/main.css?v=' . time()) ?>">
    <meta>
</head>
<body>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="<?= site_url() ?>"><?= setting('site_title') ?></a>
            ...
            <div class="dropdown">
                <?php if (session('user_id')): ?>
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="<?= site_url('admin') ?>" target="_blank">Admin Paneli</a>
                        <?php endif; ?>
